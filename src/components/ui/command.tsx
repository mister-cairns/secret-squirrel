...
function CommandGroup({
  ...
  return (
    <CommandPrimitive.Group
      ...
      className={cn("text-foreground **:[data-slot=cmdk-group-heading]:text-muted-foreground overflow-hidden p-1 **:[data-slot=cmdk-group-heading]:px-2 **:[data-slot=cmdk-group-heading]:py-1.5 **:[data-slot=cmdk-group-heading]:text-xs **:[data-slot=cmdk-group-heading]:font-medium", className)}
      {...props}
    />
  )
}
